...
if (isset($_GET['seen'])) {
    $filt_data = filteration($_GET);
    if ($filt_data['seen'] == 'all') {
...
<head>
    ...
    <title>Admin Login Panel-User Query</title>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <a href="?seen=all" class="btn btn-dark rounded-pill shadow-none btn-sm "> <i class="bi bi-check-all"></i> Marked all as Read</a>
